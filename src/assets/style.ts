...
.xb-bg-overlay{ position:fixed; inset:0; z-index:-1; background:rgba(var(--xb-bg), var(--xb-overlay, .35)); backdrop-filter: blur(2px); }
...
.xb-mobile-toggle{ display:none; }
@media (max-width: 760px){
  .xb-tabs{ display:none; }
